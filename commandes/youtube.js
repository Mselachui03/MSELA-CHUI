...
zokou({
  ...
  caption: `╭━━young africans md downloader menu━━╮
...
Views: ${videos[0].views}`,
  ...
  whatsapp: "Join my WhatsApp channel: 'https://chat.whatsapp.com/KStfBpcFDOi154eVtrz6n1'"
};
...
zokou({
  ...
  caption: `╭━━young africans md download menu━━╮
...
_*Downloading...*_`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*young africans md", gifPlayback: false }, { quoted: ms });
      });
